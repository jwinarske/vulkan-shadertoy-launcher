...
static void app_handle_xcb_event(struct app_os_window *os_window, const xcb_generic_event_t *event, bool (*save_map)[3],
                                 bool (*state_map)[2]) {
    ...
    switch (event_code) {
        ...
        case XCB_CONFIGURE_NOTIFY: {
            ...
            if ((os_window->app_data.iResolution[0] != cfg->width) ||
...
static void app_create_xcb_window(struct app_os_window *os_window) {
    ...
    xcb_create_window(os_window->connection, XCB_COPY_FROM_PARENT, os_window->xcb_window, os_window->screen->root, 0, 0,
    ...
    xcb_configure_window(os_window->connection, os_window->xcb_window, XCB_CONFIG_WINDOW_X | XCB_CONFIG_WINDOW_Y,
                         coords);
